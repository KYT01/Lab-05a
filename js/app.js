...
function multiply(a, b) {
    let multiply = a * b;
    let return1 = 'The product of ' + a + ' and ' + b + ' is ' + multiply + '.';
    return [multiply, return1];
...
function sumArray(sumArr) {
    ...
    let string4 = sumArr + ' was passed in as an array of numbers, and 9 is their sum.';
...
function multiplyArray(multArr) {
    let mult3 = multiply(multArr[0],multiply(multArr[1],multArr[2])[0])[0];
    let string5 = 'The numbers ' + multArr + ' have a product of 24.';

    return [mult3, string5]
...
function multiplyAnyArray(dynamicArray) {
  ...
  let productScript = 'The numbers ' + dynamicArray.join(',') + ' have a product of ' + product + '.';
  return [product, productScript];
}
